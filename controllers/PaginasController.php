...
class PaginasController {
    ...
    public static function contacto( Router $router ) {
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            //PHPMailer no va a funcionar porque no tengo el premium, entonces queda desactivado.
            //A futuro se puede volver a activar con una cuenta premium y cambiando todos los valores, 
            //por valores validos segun la cuenta y el nuevo dominio
